...
if __name__=='__main__':
    checkpoint = "./model/colbertv2.0"
    index_dbPath = '/workspace/raglab-exp/data/retrieval/colbertv2.0_embedding/wiki2018'
    dataset = os.path.basename(index_dbPath)
    collection = '/workspace/raglab-exp/data/retrieval/colbertv2.0_passages/wiki2018/wiki2018.tsv'
