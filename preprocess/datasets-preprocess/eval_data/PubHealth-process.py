    ...
    for item in data:
        ...
        for answer in answers:
            if answer.lower() == 'true':
                new_answers.extend(['TRUE', 'True'])
            elif answer.lower() == 'false':
                new_answers.extend(['FALSE', 'False'])
        item['answers'] = new_answers
    return data

def main():
    file_path = '/home/wyd/zxw/raglab-exp/data/eval_datasets/PubHealth/health_claims_processed.jsonl'
    max_items = 500
