...
class NPM(LM):
    ...
    def __init__(self, bm25, model_name, cache_file):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("facebook/" + self.model_name) # 这个居然也能跑通？？？tm 模型都不知道在哪里
        self.mask_id = self.tokenizer.mask_token_id

        with open("/home/wyd/data/2-factscore/roberta_stopwords.txt", "r") as f: # nm 的这肯定找不到啊，这必须得是
            self.stopwords = set()
            for line in f:
